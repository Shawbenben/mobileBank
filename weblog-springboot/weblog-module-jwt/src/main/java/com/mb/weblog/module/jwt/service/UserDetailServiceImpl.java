package com.mb.weblog.module.jwt.service;

import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.mb.weblog.common.domain.dos.UserDo;
import com.mb.weblog.common.domain.dos.UserRoleDO;
import com.mb.weblog.common.domain.mapper.UserMapper;
import com.mb.weblog.common.domain.mapper.UserRoleMapper;
...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return User.withUsername(userDO.getUsername())
                ...
                .authorities(roleArr)
                .build();
//        return User.withUsername("quanxiao")
